                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" title={{ __('Temporary disable website.') }} aria-label="Temporary disable website."></i>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" title={{ __('User can post ad without purchasing a package.') }} aria-label="User can post ad without purchasing a package."></i>
                                    </label>
                                    <div class="form-check form-switch">
