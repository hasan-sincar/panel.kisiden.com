...
class SettingController extends Controller {
    ...
    public function store(Request $request) {
        ...
        $validator = Validator::make($request->all(), [
            ...
            "favicon_icon"           => "nullable|mimes:jpg,jpeg,png,svg|max:6144",
            "company_logo"           => "nullable|mimes:jpg,jpeg,png,svg|max:6144",
            "login_image"            => "nullable|mimes:jpg,jpeg,png,svg|max:6144",
            "watermark_image"        => 'nullable|mimes:jpg,jpeg,png|max:6144',
            "web_theme_color"        => "nullable",
            "place_api_key"          => "nullable",
            "header_logo"            => "nullable|mimes:jpg,jpeg,png,svg|max:6144",
            "footer_logo"            => "nullable|mimes:jpg,jpeg,png,svg|max:6144",
            "placeholder_image"      => "nullable|mimes:jpg,jpeg,png,svg|max:6144",
            ...
            "deep_link_json_file"    => "nullable|mimes:json|max:6144",
